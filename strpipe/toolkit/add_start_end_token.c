...
static char __pyx_doc_7strpipe_7toolkit_19add_start_end_token_add_start_end_token_in_sentences[] = "add_start_end_token_in_sentences(sentences: list[list[str]], str sos_token: str = DefaultTokens.sos, str eos_token: str = DefaultTokens.eos) -> list[list[str]]";
static PyMethodDef __pyx_mdef_7strpipe_7toolkit_19add_start_end_token_1add_start_end_token_in_sentences = {"add_start_end_token_in_sentences", (PyCFunction)__pyx_pw_7strpipe_7toolkit_19add_start_end_token_1add_start_end_token_in_sentences, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7strpipe_7toolkit_19add_start_end_token_add_start_end_token_in_sentences};
...
static int __pyx_pymod_exec_add_start_end_token(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
 ...
 *     ) -> list[list[str]]:
 */
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s_DefaultTokens); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init strpipe.toolkit.add_start_end_token", 0, __pyx_lineno, __pyx_filename);
    }
