...
static int __pyx_pymod_exec_invert_dictionary(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init strpipe.toolkit.invert_dictionary", 0, __pyx_lineno, __pyx_filename);
    }
