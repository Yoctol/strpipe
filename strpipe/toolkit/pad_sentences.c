...
static char __pyx_doc_7strpipe_7toolkit_13pad_sentences_pad_sentences[] = "pad_sentences(sentences: list[list[str]], maxlen: int, str pad_token: str = DefaultTokens.pad) -> tuple[list[list[str]], dict]\n\n    transform\n    ";
static PyMethodDef __pyx_mdef_7strpipe_7toolkit_13pad_sentences_1pad_sentences = {"pad_sentences", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7strpipe_7toolkit_13pad_sentences_1pad_sentences, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7strpipe_7toolkit_13pad_sentences_pad_sentences};
static PyObject *__pyx_pw_7strpipe_7toolkit_13pad_sentences_1pad_sentences(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_maxlen)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("pad_sentences", 0, 2, 3, 1); __PYX_ERR(0, 4, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "pad_sentences") < 0)) __PYX_ERR(0, 4, __pyx_L3_error)
      }
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("pad_sentences", 0, 2, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 4, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("strpipe.toolkit.pad_sentences.pad_sentences", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_pad_token), (&PyString_Type), 1, "pad_token", 1))) __PYX_ERR(0, 7, __pyx_L1_error)
...
static PyMethodDef __pyx_mdef_7strpipe_7toolkit_13pad_sentences_3unpad_sentences = {"unpad_sentences", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7strpipe_7toolkit_13pad_sentences_3unpad_sentences, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7strpipe_7toolkit_13pad_sentences_2unpad_sentences};
 ...
 */
    ...
    __pyx_t_4 = __Pyx_PyList_GetSlice(__pyx_v_sentence, 0, __pyx_v_maxlen); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 50, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_copy); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 50, __pyx_L1_error)
 ...
 * 
 */
    __pyx_t_3 = PyNumber_Add(__pyx_v_padded_sentence, __pyx_v_diff_sentence); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 55, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF_SET(__pyx_v_padded_sentence, ((PyObject*)__pyx_t_3));
    __pyx_t_3 = 0;
  }
  __pyx_L3:;
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_pad_sentences(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'pad_sentences' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
 ...
 */
  ...
  /* "strpipe/toolkit/pad_sentences.pyx":7
 *         sentences: list[list[str]],
 *         maxlen: int,
 ...
 *     '''
 */
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_DefaultTokens); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_pad); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (!(likely(PyString_CheckExact(__pyx_t_1))||((__pyx_t_1) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "str", Py_TYPE(__pyx_t_1)->tp_name), 0))) __PYX_ERR(0, 7, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init strpipe.toolkit.pad_sentences", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
